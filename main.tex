...
\label{sec:intro}
	...
	inside the ITP. SMTCoq is the first and only 
	certified checker to the extent of our knowledge.
...
\label{sec:rel}
	...
	integratino wasn't useful. Instead, the reconstruction 
...
\label{sec:smt}
	...
	follow some modification of the DPLL(T) algorithm, which tries
...
\label{sec:hammer}
	Isabelle is a proof assistant or keeping with our terminology, 
...
\label{sec:comp}
	...
	Coq, considers the lemma to be proven. Thus,
	...
	\textcolor{red}{Say something about Coq -> SMTLIB vs 
		Isabelle/HOL -> SMTLIB.}
