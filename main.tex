...
\label{smt}
	...
	uses the resolution principle and some other 
	rules to add implied clauses to the input set of 
	...
	The superposition calculus consists of 
	the resolution rules and some additional 
	rules that perform simplification modulo equality
	and they apply these rules to the input set of 
	...
	theoretically complete, provers use an ordering 
